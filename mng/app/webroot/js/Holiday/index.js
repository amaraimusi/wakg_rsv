...
$(function() {
	...
	$('#holiday_tbl').show();// 高速表示のためテーブルは最後に表示する
...
function init(){
	...
	// CBBXS-1023
	// 休日タイプリストJSON
	var holiday_type_json = jQuery('#holiday_type_json').val();
	var holidayTypeList = JSON.parse(holiday_type_json);
	disFilData['holiday_type'] ={'fil_type':'select','option':{'list':holidayTypeList}};
	...
	// リアクト機能の初期化
	crudBase.reactInit('holiday_tbl, hyo2');
}
...
function calendarViewKShow(){
	// カレンダービューを生成 
	crudBase.calendarViewCreate('holiday_date');
}
